...
*/
  <div className="rectangle_2 flex-shrink-0 w-[1520px] h-[280px] text-white font-['Inter'] text-xl font-bold leading-[normal] rounded-[1.1875rem] border border-[#0093ff] bg-[#050B1D] display:flex justify-content-center">
  <Nav1 />
